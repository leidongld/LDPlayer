...
public class SatelliteChannelFragment extends Fragment {
    private static final String TAG = SatelliteChannelFragment.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_satellite_channel, container, false);
    ...
    private void initWidgets() {
       configSatelliteChannels();
    }

    /**
     *
     */
    private void configSatelliteChannels() {
        DataUtils.loadSatelliteChannels(new WebHeroCallback() {
            @Override
